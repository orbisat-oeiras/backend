...
{
    public class AccelerationZFinalizer : EventFinalizerBase<float>
    {
        public AccelerationZFinalizer(
            [FromKeyedServices(ServiceKeys.AccelerationZExtractor)] IDataProvider<float> provider
        )
            : base(provider) { }
