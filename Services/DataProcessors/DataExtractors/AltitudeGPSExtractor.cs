...
namespace backend24.Services.DataProcessors.DataExtractors
{
	...
	{
		public AltitudeGPSExtractor([FromKeyedServices(ServiceKeys.SerialProvider)] IDataProvider<Dictionary<SerialProvider.DataLabel, string>> provider) : base(provider) {
